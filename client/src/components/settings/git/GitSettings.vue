  ...
  <div class>
    ...
    <div class="repo-section">
      <div class="row no-gutter">
        <h4>Repositories</h4>
        <i
          :class="{'repo-toggle-icon':true, 'la': true, 'la-angle-down': reposHidden, 'la-angle-up': !reposHidden}"
          role="button"
    ...
    async getCommits(commitsUrl, token) {
      ...
      for (var i in result) {
        ...
        if (this.sliceStrFeat != null) {
          console.log(
            "PrepString Feat " + i + " : ",
            this.prepString(this.sliceStrFeat)
          );
        ...
        if (this.sliceStrTodo != null) {
          console.log(
            "PrepString Todo " + i + " : ",
            this.prepString(this.sliceStrTodo)
          );
